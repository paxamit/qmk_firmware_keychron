...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_ansi_82(
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        KC_HYPR,  KC_LGUI,  KC_LALT,                        LT(WIN_FN,KC_SPC),                              KC_RALT, MO(WIN_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_ansi_82(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  KC_PGDN,  KC_HOME,  KC_PGDN,  KC_PSCR,  _______,  _______,  _______,            _______,
